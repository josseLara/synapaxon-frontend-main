            ...
            <div className="p-6 max-w-7xl mx-auto">
              ...
              <div className="backdrop-blur-lgspace-y-8">
                ...
                <AnimatedDiv delay={1} className="mt-8">
                  <Card className=" backdrop-blur-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          ...
                          >
                            ...
                            <XAxis
                              ...
                              height={80}
                            />
                            <YAxis tick={{ fontSize: 12, fill: "#2563eb" }} domain={[0, 100]} unit="%" />
                            <Tooltip
