    ...
    const fetchTestDetail = async () => {
      try {
        ...
        const questionsResponse = await fetch(
          `${import.meta.env.VITE_API_URL || 'https://synapaxon-backend.onrender.com'}/api/student-questions/history/${testId}?${query}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
          ...
          async (question) => {
            try {
              const response = await fetch(
                `${import.meta.env.VITE_API_URL || 'https://synapaxon-backend.onrender.com'}/api/questions/${question.question?._id}`,
                {
                  headers: {
                    Authorization: `Bearer ${token}`,
                    "Content-Type": "application/json",
