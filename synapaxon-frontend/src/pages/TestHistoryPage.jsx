    ...
    const fetchTestHistory = async () => {
      try {
        ...
        const response = await fetch(
          `${import.meta.env.VITE_API_URL || 'https://synapaxon-backend.onrender.com'}/api/tests?page=${pagination.current}&limit=${pagination.limit}`,
          {
            headers: {
                        ...
                        <div className="relative w-32 h-32">
                          <svg className="w-full h-full" viewBox="0 0 100 100">
                            ...
                            <circle
                              ...
                              strokeWidth="10"
                              strokeDasharray={`${(analytics.averageScore / 100) * 283
                                } 283`}
                              strokeDashoffset="0"
                              strokeLinecap="round"
                              stroke="currentColor"
